...
|--------|-------|------|-----------------|-------|
| ADJ-A | A + B + F | Quick wins: Ranked lock · Delete users · Créditos | `index.html` · sqlite | 🟢 Baixo |
| ADJ-B | C | Sistema de Inatividade (substituição completa) | `server.js` · `index.html` | 🔴 Alto |
| ADJ-C | D | Sistema de Desconexão (rework + guests) | `server.js` · `index.html` | 🟠 Médio |
| ADJ-D | E | Empate por dupla inatividade/desconexão | `server.js` · `index.html` | 🟠 Médio |
...
Dependências: ADJ-B deve preceder ADJ-C e ADJ-D. ADJ-A é totalmente independente.
